...
with open("demoresults/classification_reports/classification_report_" + now + "_th_" + str(treshhold) + ".txt", "w") as text_file:
...
plt.savefig('demoresults/confusion_matrix_' + now + '_th_' + str(treshhold) + '.png')
